...
function metryczka5($imie, $nazwisko, $klub, $konk1, $konk1W, $konk1K, $konk2, $konk2W, $konk2K, $konk3, $konk3W, $konk3K, $konk4, $konk4W, $konk4K, $konk5, $konk5W, $konk5K, $nr) : string {
...
<body>
    ...
    <div id='ramka'>
        ...
        <table id='duzytab'>
            ...
            <tr>
                <td class='konkurencja'>$konk5</td>
                <td id='bron'>
                    <table id='zaznaczanie'>
                        <tr>
                            <td id='lewy'>$konk5W</td>
                            <td id='prawy'>$konk5K</td>
                        </tr>
                    </table>
                </td>
                <td></td>
